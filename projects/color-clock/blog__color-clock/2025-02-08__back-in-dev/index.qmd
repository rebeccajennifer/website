---
title       : "Back In Development"
description : "Leveling up ColorClock with testing, tooling, and better software design."
date        : 2025-02-08
categories  : [color-clock, testing]
image       : ascii-bunny.png
draft       : false
---
...
![](wire-harness-v1-home-display__2025-02-10.png)
...
![](terminal-block.JPEG)
*For home display, we removed the wire harness from Version 1 and
directly connected the LED strips to the terminal block, which we
relocated to the back of the light display.*

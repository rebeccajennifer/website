...
subtitle: Enable your journey to your ideal self.
order: 1
listing:
  contents: ./
  type: default
...
The planner consists of a series of PDFs formatted for printing on 8.5×11 sheets, which are then cut in half and placed into a half-sheet three-ring binder.
...
This file serves as a preview of the planner; it it not formatted for printing. For printing instructions, visit [How to Assemble The Book of Plans](./assembly-instructions.qmd).

<a class="flux-button _2" href="./images__the-book-of-plans/book-of-plans-full-preview.pdf">Planner Preview</a>

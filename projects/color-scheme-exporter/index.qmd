...
Follow instructions [here](../../reference/color-scheme__reference/gnome-terminal-color.qmd) for how to invoke a GNOME color scheme.
...
Follow instructions [here](/reference/color-scheme__reference/vscode-color.qmd) to add your theme file as a pacakge to VS Code.

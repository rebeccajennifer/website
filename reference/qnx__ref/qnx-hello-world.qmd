...
image: ./images__qnx-ref/3__hello-world-img/3__hello-world-07-term-run.png
description: >
...
[QNX Toolkit for Visual Studio Code](https://www.qnx.com/developers/docs/qnxtoolkit/index.html){class="flux-button _3"}
...
1. In VS Code, select QNX from the Activity Bar on the left side of the screen.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-00-ext.png)

1. From the left sidebar under `QNX COMMANDS` select `Projects > Create new Project...`.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-00.png)

1. Type the name of your project, e.g. `hello_world`.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-01-project-name.png)

1. Select `QNX Recursive Makefile` for the template.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-02-project-template.png)

1. Select `c` for language.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-03-language.png)

1. Select `Executable` for build artifact.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-04-artifact.png)
...
1. To compile, right-click on the project folder and go to `QNX > Build Active Project`.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-05.png)
...
1. Verify that the target created is labeled as `default` from the `QNX TARGETS` section of the  QNX sidebar.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-run-vscode-00.png)
...
1. Right-click on the project folder and go to `QNX > Run as QNX Application...`.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-run-vscode-01.png)

1. If everything is configured properly, `Hello QNX` should print to the debug console.

   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-run-vscode-02.png)
...
![](./images__qnx-ref/3__hello-world-img/3__hello-world-errors-00-getaddrinfo.png)
...
![](./images__qnx-ref/3__hello-world-img/3__hello-world-errors-01-arp.png)
...
1. On the running target, navigate to `/data/home/root` and execute `ls`. You should see your `hello_world` executable.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-06-term-loc.png)
...
1. From the target terminal, run the executable.
   ...
   ![](./images__qnx-ref/3__hello-world-img/3__hello-world-07-term-run.png)

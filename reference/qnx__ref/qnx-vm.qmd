...
1. [Create an SSH Key](/reference/environment-setup__ref/git.qmd#github).
...
If you do not already have an SSH key set up, follow instructions from [this page](/reference/environment-setup__ref/git.qmd#github).
...
1. For `Enter extra mkqnximage options`, add `--ssh-ident=/path/to/public/ssh/key`.
   ...
   Make sure to use the full path, i.e. `/home/username` instead of `~`. If you do not have an SSH Key set up already, follow instructions [here](/reference/environment-setup__ref/git.qmd#github).

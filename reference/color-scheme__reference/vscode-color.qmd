---
title: VS Code Custom Color Theme Example
subtitle: How to create a VS Code color theme file.
description: >
  Here you’ll find instructions for installing my custom VS Code themes, plus a walkthrough on how to make and load your own.
toc-depth: 6
order: 4
---
...
![](images__color-scheme-reference/vscode-flux-dark-screenshot.png)
...
## Install Flux Bunny Themes

To install my custom color themes, follow these instructions.

1. Download or clone the directory `flux-bunny-color-schemes` from here:

   [Flux Bunny Color Schemes](https://github.com/rebeccajennifer/setup-files/tree/main/vscode/flux-bunny-color-schemes){class="flux-button _3"}

1. Save this directory to your user extensions directory, often located in the following directories:
...
1. You can delete `flux-bunny-template.json` from this directory.

1. In VS Code, use the shortcut `Ctrl+Shift+P` to go to the Command Palette. Type `Color Theme` and select the option for Color Theme. You should see `Flux Bunny Lite` under light themes and `Flux Bunny Dark` under dark themes.

   ![](images__color-scheme-reference/vscode-select-pref-color-theme.png)

   ![](images__color-scheme-reference/vscode-color-theme-flux-bunny-colors.png)
...
![](images__color-scheme-reference/vscode-wrong-uitheme-example.png)
...
![](images__color-scheme-reference/vscode-color-theme-selection.png)

You should now see your defined colors in the editor window.

![](images__color-scheme-reference/vscode-miminal-theme-example.png)
...
You may want to start from an existing theme file. You can use the dark theme I have created [here](#install-flux-bunny-themes). You can also copy an existing theme from the defaults. Depending on how VS Code was installed, default theme files might be found here:

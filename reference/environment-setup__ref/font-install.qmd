...
image: ./images__env-setup/font-install__env-setup__images/04__draw.io-font-change-01.png
toc-depth: 6
draft: false
---
...
1. The text `Arduino` now displays the correct font. However, the rest of the text in the drawing is still set to `Lucida Console` instead of the installed font name `Lucida Console W1G VF`.

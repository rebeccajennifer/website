...
[VS Code Docs: Color Theme Properties](https://code.visualstudio.com/api/references/theme-color){class="flux-button _3"}
...
![](./images__color-scheme-reference/vscode-open-extensions-dir.png)

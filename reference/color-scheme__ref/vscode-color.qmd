...
subtitle: How to create a Visual Studio Code color theme file.
description: >
  A detailed example on how to create and load a Visual Studio Code color theme
  file
toc-depth: 6
order: 4
---
...
![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-flux-dark-screenshot.png)

## Visual Studio Code Documentation

See this page for a complete list of VS Code color theme properties.

[Color Theme Properties](https://code.visualstudio.com/api/references/theme-color){class="flux-button _3"}

## My Original Themes

See this link for a copy of my personally designed dark and light themes.

[Lagomorphic Constructs Theme Pack](https://github.com/rebeccajennifer/setup-files/tree/main/vscode/rebecca-jennifer.flux-bunny-themes){class="flux-button _3"}

### Custom Theme Installation Instructions

Download the directory `rebecca-jennifer.flux-bunny-themes` and copy it into your VS Code extensions directory.

OS | Extensions Directory Path
-|-
Linux   | `~/.vscode/extensions`
Windows | `C:\<username>\.vscode\extensions`

__Note:__ If you installed VS Code in a non-conventional way, your extensions directory might exist in a different location than listed above. Verify the location of your extensions directory by selecting `Developer: Open Extensions Folder` from the command palette.

![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-open-extensions-dir.png)
...
![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-wrong-uitheme-example.png)
...
![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-select-pref-color-theme.png)

The theme `My Dark Theme` should now display in the drop down options.

![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-color-theme-selection.png)

You should now see your defined colors in the editor window.

![](/reference/color-scheme__ref/images__color-scheme-reference/vscode-miminal-theme-example.png)

...
This section consists of grayscale colors and occupies indices 232 (near black) through 255 (near white).

#### RGB to ANSI 256 Index Conversion

For shades of grey, each of the RGB components have the same value.

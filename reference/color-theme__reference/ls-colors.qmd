...
2. Insert the following command in your `.bashrc` or `.bash_profile`:
   ```bash
...
Using `tmux` can sometimes affect your environment, specifically how colors are displayed. This section explains how to configure your environment so the colors you so carefully chose display properly inside `tmux`.

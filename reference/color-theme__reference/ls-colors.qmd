...
![](images__color-theme-reference/dircolors-sample-header.png)
...
6. Save a file with the name `.randomfiletype` and run the command
   ...
   ![](images__color-theme-reference/dircolors-sample.png)
...
![](./images__color-theme-reference/tmux-screenshot.png)
